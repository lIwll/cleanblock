...
[ExecuteInEditMode, RequireComponent( typeof( CanvasRenderer ) ), RequireComponent( typeof( ParticleSystem ) )]
public class UIParticleSystem : MaskableGraphic
{
    ...
    protected bool Initialize ( )
    {
        ...
        else
        {
            ...
            {
                setParticleSystemMaterial = ( particleSystemRenderer.material == null );
            }
			else
			{
                setParticleSystemMaterial = ( particleSystemRenderer.sharedMaterial == null );
			}
        }
        ...
        {
            Material material = UIManager.GetHideMaterial();
            if (Application.isPlaying)
            {
    ...
    protected override void Start ( )
    {
        ...
        if (!particleTexture || particleTexture != material.mainTexture)
        {
            particleTexture = material.mainTexture;
        }

        if (Application.isPlaying && _particleSystem) 
        {
